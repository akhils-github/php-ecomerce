...
if(isset($_GET['edit_account'])){
    ...
    $user_phone = $row_user_fetch['phone'];
    $user_image = $row_user_fetch['image'];
...
if(isset($_POST['user_update'])){
    ...
    // update query 
    $update_query = "UPDATE `user_table` SET username='$update_user',image='$update_image',phone='$update_phone' WHERE id=$update_id";
            ...
            <div class="col-md-6">
                ...
                <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-3">
                    ...
                    <div class="form-outline">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control" value="<?php echo $user_phone;?>">
                    </div>
