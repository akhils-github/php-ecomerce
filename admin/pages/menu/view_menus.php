        ...
        <div class="table-data">
            <table class="table table-bordered table-hover table-striped text-center">
                ...
                <tbody>
                    <?php
                    //get Brand info
                    $get_menu_query = "SELECT * FROM `menus`";
                    $get_menu_result = mysqli_query($con, $get_menu_query);
                    $id_number = 1;
                    while ($row_fetch_menus = mysqli_fetch_array($get_menu_result)) {
                        $menu_id = $row_fetch_menus['id'];
                        $name = $row_fetch_menus['name'];
                        $description = $row_fetch_menus['description'];
                        // $category_id = $row_fetch_menus['category_id'];
                        $price = $row_fetch_menus['price'];
                        $image = $row_fetch_menus['image'];
                        echo "
                            <tr>
                            <td>$id_number</td>
                            <td>$name</td>
                            ...
                            <td>
                                <a href='index.php?delete_menu=$menu_id' data-bs-toggle='modal' data-bs-target='#deleteModal_$menu_id'>
                                ...
                                <!-- Modal -->
                                <div class='modal fade' id='deleteModal_$menu_id' tabindex='-1' aria-labelledby='deleteModal_$menu_id.Label' aria-hidden='true'>
                                                ...
                                                <div class='d-flex flex-column gap-3 align-items-center text-center'>
                                                    ...
                                                    <div class='btns d-flex gap-3'>
                                                        ...
                                                        <button type='button' class='btn px-5 btn-primary' data-bs-dismiss='modal'>
                                                            <a class='text-light' href='index.php?delete_menu=$menu_id'>
                                                                Delete 
                                                            </a>
                                                        </button>
                                                    </div>
