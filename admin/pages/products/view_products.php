                ...
                <tbody>
                    <?php
                        ...
                        while($row_fetch_products = mysqli_fetch_array($get_product_result)){
                            ...
                            $product_title = $row_fetch_products['name'];
                            $product_image_one = $row_fetch_products['image_one'];
                            $product_price = $row_fetch_products['price'];
                            ...
                            <td>$product_title</td>
                            <td>
                                <img src='../uploads/images/products/$product_image_one' alt='$product_title' width='80px' class='img-thumbnail'/>
                            </td>
                            <td>₹ $product_price </td>
