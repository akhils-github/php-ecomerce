...
if (isset($_GET['edit_product'])) {
    ...
    $product_image_one_old = $row_fetch_data['image_one'];
    $product_image_two_old = $row_fetch_data['image_two'];
    $product_image_three_old = $row_fetch_data['image_three'];
    $product_price = $row_fetch_data['price'];
}
// edit product
if (isset($_POST['update_product'])) {
    ...
    // check empty fields 
    if (empty($product_title) || empty($product_description)  || empty($product_category_id)  || empty($product_image_one) || empty($product_price)) {
        echo "<script>window.alert('Please fill all fields');</script>";
    } else {
        move_uploaded_file($product_image_one_tmp, "../uploads/images/products/$product_image_one");
        move_uploaded_file($product_image_two_tmp, "../uploads/images/products/$product_image_two");
        move_uploaded_file($product_image_three_tmp, "../uploads/images/products/$product_image_three");
        // update query 
        $update_product_query = "UPDATE `products` SET category_id=$product_category_id,name='$product_title',description='$product_description',image_one='$product_image_one',image_two='$product_image_two',image_three='$product_image_three',price='$product_price',date=NOW() WHERE id = $edit_id";
...
<form action="" method="post" enctype="multipart/form-data" class="row gap-3 mb-3">
    ...
    <div class="form-outline col-md-5">
        ...
        <select name="product_category" id="product_category" class="form-select" required>
            ...
            while ($fetch_category_name_all = mysqli_fetch_array($select_category_result_all)) {
                $category_name_is_all = $fetch_category_name_all['name'];
                $category_id_is_all = $fetch_category_name_all['id'];
    ...
    <div class="form-outline col-md-5">
        ...
        <div class="d-flex gap-3 w-100">
            ...
            <img src="../uploads/images/products/<?php echo $product_image_one_old; ?>" alt="<?php echo $product_title; ?>" class="img-thumbnail" width="100px">
        </div>
    </div>
    <div class="form-outline col-md-5">
        ...
        <div class="d-flex gap-3 w-100">
            ...
            <img src="../uploads/images/products/<?php echo $product_image_two_old; ?>" alt="<?php echo $product_title; ?>" class="img-thumbnail" width="100px">
        </div>
    </div>
    <div class="form-outline col-md-5">
        ...
        <div class="d-flex gap-3 w-100">
            ...
            <img src="../uploads/images/products/<?php echo $product_image_three_old; ?>" alt="<?php echo $product_title; ?>" class="img-thumbnail" width="100px">
        </div>
    </div>

    <div class="form-outline text-center col-md-10">
