                ...
                <tbody>
                    <?php
                        ...
                        while($row_fetch_categories = mysqli_fetch_array($get_category_result)){
                            $category_id = $row_fetch_categories['id'];
                            $category_title = $row_fetch_categories['name'];
                            $category_image = $row_fetch_categories['image'];
                            echo "
                            <tr>
                            <td>$id_number</td>
                            <td>$category_title</td>
                            <td> <img src='../uploads/images/category/$category_image' alt='$category_title' width='80px' class='img-thumbnail'/></td>
                            <td>
